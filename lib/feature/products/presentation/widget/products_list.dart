                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Cart userCart = savedCart.firstWhere(
                        ...
                        orElse: () => Cart(userId: currentUser.id!, products: [], total: 0, discountedTotal: 0, id: currentUser.id!, totalProducts: 0, totalQuantity: 0)
                      );
                      ...
                      final cartProduct = Product(
                        ...
                        discountedTotal: product.price!.toDouble() - (product.price!.toDouble() * (product.discountPercentage!.toDouble() / 100)),
                      ...
                      if (json != null && json.isNotEmpty) {
                        userCarts = UserCartResponse.fromJson(jsonDecode(json));
                      } else {
                        userCarts = UserCartResponse(carts: [],total: 0,limit: 0,skip: 0);
                      }

                      bool showCartGif = userCart.products.any((product) => product.id == cartProduct.id);
                                  ...
                                  onPressed: () {
                                    if (showCartGif) {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(
                                          content: Text(" ${product.title} is already in cart"),
                                          backgroundColor: const Color.fromARGB(255, 168, 175, 76),
                                        ),);
                                    }
                                    else{
                                      setState(() {
                                      ...
                                      if (userCarts.carts.isNotEmpty) {
                                        ...
                                        for (var cart in userCarts.carts) {
                                        ...
                                        if (existingCart != null) {
                                          ...
                                          discountedTotal = existingCart.discountedTotal;
                                          totalProducts = existingCart.totalProducts;
                                          totalQuantity = existingCart.totalQuantity;

                                          existingCart.products.add(cartProduct);
                                          total += cartProduct.price;
                                          discountedTotal += cartProduct.discountedTotal;
                                          totalProducts = existingCart.products.length;
                                          totalQuantity += 1;
                                        } else {
                                          ...
                                          userCarts.carts.add(existingCart);
                                        }
                                      } else {
                                      ...
                                      final updatedCartJson = userCarts.toJson();
